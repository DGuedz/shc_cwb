...
<h1 className="font-archivo shc-hero font-bold uppercase tracking-tighter leading-[0.85] max-w-4xl">
  <span className="block title-chromatic reveal-delay-1">LINHA BRANCA</span>
...
- Linha branca: `title-chromatic` (clip-in + shimmer CSS)
- Linha verde: `title-reveal` sem chromatic (cor mantida)
...
- Sempre com `<ScrollRevealTitle chromatic>` para o clip + shimmer no scroll
...
| `title-chromatic` | clip-in + shimmer prateado |
...
| Componente | Uso |
|---|---|
| `<ScrollRevealTitle chromatic>` | clip + shimmer nos H2 de seção |
