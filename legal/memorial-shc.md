# MEMORIAL STREET HUB CONNECT
FILHA ASTEPAM — GOVERNANÇA FONOGRÁFICA ON-CHAIN
...
As propostas delineadas no presente memorial foram baseadas nas seguintes normas e legislações:

- **Constituição Federal – Art. 5º, XXVII e XXVIII** → Proteção dos direitos autorais e direitos conexos do artista
...
- **ISO 26.000** → Responsabilidade social implementada via métricas de impacto na economia criativa
- **ABNT – NBR 16.001, 16.002 e 16.003** → Normas de governança do terceiro setor
- **Demais normas aplicáveis**

---

## 3 – DAS ATIVIDADES PROPOSTAS (FILHAS SHC)

Para a Street Hub Connect, as filhas base são:
...
- Ações de saúde e previdência para trabalhadores autônomos da cultura
- Bolsas de estudo em produção musical, tecnologia e empreendedorismo criativo
- Programas de inclusão de artistas de periferias e comunidades
- Atividades culturais, shows beneficentes e festivais de impacto social
- Programa de ação nas comunidades onde os associados atuam

### 3.2 – SHC TECNOLOGIA (ICT)
...
- Sistema de dossiê digital rastreável com metadados SEO e JSON-LD
...
Constituição de associação para gestão de direitos fonográficos, proteção de propriedade intelectual e governança do catálogo dos artistas associados:

**Vinculação:** Lei 9.610/98 (direitos autorais) + Lei 13.019/14 (terceiro setor) + Resolução CFC 1.003/04 (NBC T 15); mensurado via ISRC Registry e trilha auditável on-chain.

- Emissão e administração de ISRCs para gravações dos associados
- Registro e proteção de composições, letras e arranjos
- Gestão de contratos de licenciamento de obras (sync, publicidade, streaming)
- Banco de créditos culturais e fonográficos
- Programa de balanço social e cultural (NBC T 15 aplicado à economia criativa)
- Intermediação com ECAD, ABPD e demais entidades de gestão coletiva
- Proteção de identidade digital do artista contra impersonação e uso não autorizado

---

## 4 – PROGRAMA ESPECIAL – FUNDO PATRIMONIAL SHC
...
- Doações inicializadas pelos fundadores e associados fundadores
- 2% do lucro operacional de empresas associadas via Lei 9.249/95
- 1,5% do lucro operacional para P&D fonográfico via Lei 9.249/95
- Taxas de associação e mensalidades dos membros
- Receitas de licenciamento de metodologia curatorial
- Royalties e splits de acordos intermediados pela plataforma
...
O FUNDO PATRIMONIAL tem como base de atuação:

- 50% dos rendimentos reinvestidos no Montante Principal (não gasto)
- 50% dos rendimentos destinados aos projetos e atividades das filhas
- Financiamento de carreiras de artistas em início de trajetória
- Custeio de registro de ISRCs e proteção de obras
- Financiamento subsidiado para produção de EPs e álbuns independentes
- Investimentos em tecnologia e inovação da plataforma SHC
- Ações sociais em comunidades com artistas em vulnerabilidade
...
## 5 – PARA IMPLANTAÇÃO NA SHC

### 5.1 – Inicial — Seminário de Fundadores

Realização de seminário com fundadores, diretoria, conselheiros e parceiros estratégicos do setor musical, com duração de 3 horas. O valor do seminário pode ser utilizado como renúncia fiscal via Lei 9.249/95.

### 5.2 – Definição de Estrutura Legal

- Registro formal da SHC como associação filha da ASTEPAM
...
Capacitação dos gestores e associados em governança fonográfica, uso da plataforma SHC, registro de ISRCs e gestão de acordos. Curso a distância gratuito para artistas associados.

### 5.4 – Formação dos Grupos de Trabalho

- Conselho Administrativo SHC
- Diretoria Executiva
- Conselho de Profissionais Fonográficos (autoridade técnica sobre ISRCs e direitos)
- Conselho Fiscal (contadores habilitados)
- Comitê de Curadoria
...
## 6 – DOS BENEFÍCIOS DA ESTRUTURA SHC

Com a implantação completa:
...
- Registro de hash de todos os dossiês, acordos e contratos via EAS
- **ISRC como SpectralHash Fonográfico** — identificador único e imutável de cada gravação, análogo ao SpectralHash mineral do GEMLAB
- Multi-sig Safe para governança coletiva dos associados
- Split Payment automatizado para distribuição de royalties e cachês
- Integração com gov.br para validação de CNPJs de contratantes
- Dossiê Digital Rastreável entregue ao artista com hash on-chain como prova de autoria

---

## 8 – PROGRAMA ESPECÍFICO — ISRC E AUTONOMIA FONOGRÁFICA
...
## 9 – SEMINÁRIO CORPORATIVO DE LANÇAMENTO

Seminário de lançamento público da Street Hub Connect com a presença de fundadores, artistas, marcas, representantes do setor cultural e parceiros estratégicos.

### 9.1 – Participantes sugeridos
- Diego Guedes (DGuedz) — Fundador
- Diretoria ASTEPAM (ICT Mãe)
- Artistas fundadores do catálogo inaugural
- Representantes de marcas e contratantes parceiros
- Assessor jurídico especializado em direitos autorais
- Contador especializado em terceiro setor e incentivos fiscais
- Representante da ABPD/IFPI (ISRC)
...
O presente memorial apresenta a estrutura completa da **Street Hub Connect** como filha especializada da ICT Mãe ASTEPAM para o setor de economia criativa brasileira. A SHC opera como a infraestrutura que faltava ao artista independente: identidade digital verificável, ISRC próprio com rastreabilidade on-chain, accordos com histórico imutável e acesso a oportunidades curadas.

O sistema segue os princípios não negociáveis da ASTEPAM: AI First no backend (nunca como marketing), decisão sensível exige validação humana, dados sensíveis off-chain, hash on-chain, e comunicação B2B enxuta e auditável.

A origem do projeto não é acadêmica nem corporativa. É vivida. 25 anos de mercado musical independente transformados em infraestrutura coletiva.
